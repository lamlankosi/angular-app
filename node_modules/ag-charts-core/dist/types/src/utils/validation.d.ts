...
export declare class ValidationError {
    ...
    constructor(message: string, path: string, required?: boolean | undefined, unknown?: boolean | undefined);
    toString(): string;
}
/**
 ...
 * @returns A validator function for the given option definitions.
 */
export declare const partialDefs: <T>(defs: OptionsDefs<T>, description?: string) => Validator;
/**
...
export declare const typeUnion: <T extends {
    type: string;
}>(defs: { [K in T["type"]]: OptionsDefs<Omit<Extract<T, {
    type: K;
}>, "type">>; }, description?: string) => Validator;
export {};
