...
var _BBox = class _BBox {
  ...
  intersection(other) {
    if (!this.collidesBBox(other))
      return;
    const newX1 = (0, import_ag_charts_core.clamp)(other.x, this.x, other.x + other.width);
    const newY1 = (0, import_ag_charts_core.clamp)(other.y, this.y, other.y + other.height);
    const newX2 = (0, import_ag_charts_core.clamp)(other.x, this.x + this.width, other.x + other.width);
    const newY2 = (0, import_ag_charts_core.clamp)(other.y, this.y + this.height, other.y + other.height);
  ...
  distanceSquared(x, y) {
    ...
    const dx = x - (0, import_ag_charts_core.clamp)(this.x, x, this.x + this.width);
    const dy = y - (0, import_ag_charts_core.clamp)(this.y, y, this.y + this.height);
    return dx * dx + dy * dy;
  }
...
var _Node = class _Node {
  ...
  *descendants() {
  ...
  append(nodes) {
    ...
    for (const node of (0, import_ag_charts_core2.toIterable)(nodes)) {
...
var Matrix = class _Matrix {
  ...
  get identity() {
    const e = this.elements;
    return (0, import_ag_charts_core3.isNumberEqual)(e[0], 1) && (0, import_ag_charts_core3.isNumberEqual)(e[1], 0) && (0, import_ag_charts_core3.isNumberEqual)(e[2], 0) && (0, import_ag_charts_core3.isNumberEqual)(e[3], 1) && (0, import_ag_charts_core3.isNumberEqual)(e[4], 0) && (0, import_ag_charts_core3.isNumberEqual)(e[5], 0);
  }
  /**
  ...
  class MatrixTransformInternal extends ParentNode {
    ...
    toSVG() {
      ...
      if (matrix.identity || svg == null)
        return svg;
      const g = (0, import_ag_charts_core4.createSvgElement)("g");
...
var _Color = class _Color {
  ...
  constructor(r, g, b, a = 1) {
    this.r = (0, import_ag_charts_core6.clamp)(0, r || 0, 1);
    this.g = (0, import_ag_charts_core6.clamp)(0, g || 0, 1);
    this.b = (0, import_ag_charts_core6.clamp)(0, b || 0, 1);
    this.a = (0, import_ag_charts_core6.clamp)(0, a || 0, 1);
  }
  /**
  ...
  static stringToRgba(str) {
    ...
    for (let i = 0; i < parts.length; i++) {
      ...
      if (part.indexOf("%") >= 0) {
        value = (0, import_ag_charts_core6.clamp)(0, value, 100);
        value /= 100;
      } else if (i === 3) {
        value = (0, import_ag_charts_core6.clamp)(0, value, 1);
      } else {
        value = (0, import_ag_charts_core6.clamp)(0, value, 255);
        value /= 255;
      }
      rgba.push(value);
    }
  ...
  static lighten(c, t) {
    ...
    return _Color.fromOKLCH((0, import_ag_charts_core6.clamp)(0, oklch[0] + t, 1), oklch[1], oklch[2]);
  }
  static darken(c, t) {
    const oklch = _Color.RGBtoOKLCH(c.r, c.g, c.b);
    return _Color.fromOKLCH((0, import_ag_charts_core6.clamp)(0, oklch[0] - t, 1), oklch[1], oklch[2]);
...
var BaseProperties = class {
  ...
  set(properties) {
    ...
    if (typeof properties !== "object") {
      import_ag_charts_core12.Logger.warn(`unable to set ${className} - expecting a properties object`);
      return this;
    }
        ...
        if (isProperties(self[propertyKey])) {
          if (self[propertyKey] instanceof PropertiesArray) {
            ...
            if (array != null) {
              ...
              import_ag_charts_core12.Logger.warn(`unable to set [${propertyKey}] - expecting a properties array`);
            }
          } else {
            self[propertyKey].set(value);
          }
        } else if ((0, import_ag_charts_core12.isPlainObject)(value)) {
    ...
    for (const unknownKey of keys) {
      import_ag_charts_core12.Logger.warn(`unable to set [${unknownKey}] in ${className} - property is unknown`);
    }
    return this;
  }
  isValid(warningPrefix) {
    return listDecoratedProperties(this).every((propertyKey) => {
      ...
      if (metadata == null)
        return true;
      const valid = metadata.optional === true || typeof this[propertyKey] !== "undefined";
      if (!valid) {
        import_ag_charts_core12.Logger.warnOnce(`${warningPrefix ?? ""}[${propertyKey}] is required.`);
      }
      return valid;
    });
  }
...
var PropertiesArray = class _PropertiesArray extends Array {
  ...
  set(properties) {
    if ((0, import_ag_charts_core12.isArray)(properties)) {
...
var TestEnv = false;
var TempValidate = TestEnv ? (predicate, options = {}) => {
  ...
  return addTransformToInstanceProperty(
    (target, property, value) => {
      ...
      if (optional && typeof value === "undefined" || predicate(value, context)) {
        ...
        const valueString = (0, import_ag_charts_core13.stringifyValue)(value, 50);
        ...
        import_ag_charts_core13.Logger.warn(
...
var OBJECT = attachObjectRestrictions(
  predicateWithMessage(
    (value, ctx) => isProperties(value) || (0, import_ag_charts_core13.isObject)(value) && isProperties(ctx.target[ctx.property]),
    "a properties object"
  )
);
var PLAIN_OBJECT = attachObjectRestrictions(predicateWithMessage((value) => (0, import_ag_charts_core13.isObject)(value), "an object"));
var BOOLEAN = predicateWithMessage(import_ag_charts_core13.isBoolean, "a boolean");
var FUNCTION = predicateWithMessage(import_ag_charts_core13.isFunction, "a function");
var STRING = predicateWithMessage(import_ag_charts_core13.isString, "a string");
var NUMBER = attachNumberRestrictions(predicateWithMessage(import_ag_charts_core13.isFiniteNumber, "a number"));
var REAL_NUMBER = predicateWithMessage((value) => (0, import_ag_charts_core13.isNumber)(value) && !isNaN(value), "a real number");
var NAN = predicateWithMessage((value) => (0, import_ag_charts_core13.isNumber)(value) && isNaN(value), "NaN");
var POSITIVE_NUMBER = NUMBER.restrict({ min: 0 });
var RATIO = NUMBER.restrict({ min: 0, max: 1 });
var NUMBER_OR_NAN = OR(NUMBER, NAN);
var ARRAY = attachArrayRestrictions(predicateWithMessage(import_ag_charts_core13.isArray, "an array"));
var ARRAY_OF = (predicate, message) => predicateWithMessage(
  (value, ctx) => (0, import_ag_charts_core13.isArray)(value) && value.every((item) => predicate(item, ctx)),
  (ctx) => {
...
var isComparable = (value) => (0, import_ag_charts_core13.isFiniteNumber)(value) || (0, import_ag_charts_core13.isValidDate)(value);
...
var DATE = predicateWithMessage(import_ag_charts_core13.isValidDate, "Date object");
...
var COLOR_STRING = predicateWithMessage(import_ag_charts_core13.isColor, `color string. ${colorMessage}`);
var COLOR_GRADIENT = attachObjectRestrictions(
  predicateWithMessage((value) => (0, import_ag_charts_core13.isObject)(value) && value.type === "gradient", "a color gradient object")
);
var COLOR_PATTERN = attachObjectRestrictions(
  predicateWithMessage((value) => {
    return (0, import_ag_charts_core13.isObject)(value) && value.type === "pattern";
  ...
  return predicateWithMessage(
    (v, ctx) => {
      ...
      if (typeof option !== "string" && (option.deprecated === true || option.deprecatedTo != null)) {
        ...
        import_ag_charts_core13.Logger.warnOnce(messages.join(" "), ctx.property);
      }
      return true;
    },
...
function getPredicateMessage(predicate, ctx) {
  return (0, import_ag_charts_core13.isFunction)(predicate.message) ? predicate.message(ctx) : predicate.message;
}
...
function attachArrayRestrictions(predicate) {
  return Object.assign(predicate, {
    restrict({ length, minLength } = {}) {
      ...
      if ((0, import_ag_charts_core13.isNumber)(minLength) && minLength > 0) {
        message = "a non-empty array";
      } else if ((0, import_ag_charts_core13.isNumber)(length)) {
        message = `an array of length ${length}`;
      }
      return predicateWithMessage(
        (value) => (0, import_ag_charts_core13.isArray)(value) && ((0, import_ag_charts_core13.isNumber)(length) ? value.length === length : true) && ((0, import_ag_charts_core13.isNumber)(minLength) ? value.length >= minLength : true),
        message
      );
    }
  });
...
function attachNumberRestrictions(predicate) {
  return Object.assign(predicate, {
    restrict({ min, max } = {}) {
      ...
      const hasMin = (0, import_ag_charts_core13.isNumber)(min);
      const hasMax = (0, import_ag_charts_core13.isNumber)(max);
      if (hasMin && hasMax) {
      ...
      return predicateWithMessage(
        (value) => (0, import_ag_charts_core13.isFiniteNumber)(value) && (hasMin ? value >= min : true) && (hasMax ? value <= max : true),
        message.join(" ")
      );
    }
  });
...
var logTimeGap = () => {
  ...
  if (timeSinceLastLog > LONG_TIME_PERIOD_THRESHOLD) {
    ...
    import_ag_charts_core15.Logger.log(`**** ${prettyDuration}s since last log message ****`);
  }
...
var Debug = {
  create(...debugSelectors) {
    const resultFn = (...logContent) => {
      if (Debug.check(...debugSelectors)) {
        if (typeof logContent[0] === "function") {
          logContent = (0, import_ag_charts_core15.toArray)(logContent[0]());
        }
        logTimeGap();
        import_ag_charts_core15.Logger.log(...logContent);
      }
    };
    return Object.assign(resultFn, {
      ...
      group: (name, cb) => {
        if (Debug.check(...debugSelectors)) {
          return import_ag_charts_core15.Logger.logGroup(name, cb);
        }
        return cb();
      }
    });
  ...
  check(...debugSelectors) {
    ...
    const chartDebug = (0, import_ag_charts_core15.toArray)((0, import_ag_charts_core15.getWindow)("agChartsDebug"));
  ...
  distanceSquared(x, y) {
    ...
    for (let ci = 0, pi = 0; ci < cn; ci++) {
      switch (commands[ci]) {
        ...
        case 3 /* Curve */:
          import_ag_charts_core16.Logger.error("Command.Curve distanceSquare not implemented");
          break;
        case 2 /* Arc */: {
          const cx = params[pi++];
          const cy = params[pi++];
...
// packages/ag-charts-community/src/scene/pattern/pattern.ts
var Pattern = class {
  constructor(patternOptions, pixelRatio = 1) {
    this.pixelRatio = pixelRatio;
    this._cache = void 0;
...
function isGradientFill(fill) {
  return (0, import_ag_charts_core18.isObject)(fill) && fill.type == "gradient";
}
function isPatternFill(fill) {
  return fill !== null && (0, import_ag_charts_core18.isObject)(fill) && fill.type == "pattern";
}
...
var _Shape = class _Shape extends Node {
  ...
  applyFill(ctx) {
    ...
    const gradientFill = fillBBox ? fillGradient?.createGradient(ctx, fillBBox, fillParams) : void 0;
    const patternFill = this.fillPattern?.createPattern(ctx);
    ctx.fillStyle = patternFill ?? gradientFill ?? (typeof fill === "string" ? fill : void 0) ?? "black";
  }
  applyStroke(ctx) {
...
__decorateClass([
  SceneChangeDetection({ convertor: (v) => (0, import_ag_charts_core19.clamp)(0, v, 1) })
...
var _Text = class _Text extends Shape {
  ...
  toSVG() {
    if (!this.visible || !this.text)
      return;
    const element = (0, import_ag_charts_core20.createSvgElement)("text");
...
var Path = class extends Shape {
  ...
  toSVG() {
    if (!this.visible)
      return;
    const element = (0, import_ag_charts_core22.createSvgElement)("path");
...
var TimeInterval = class {
   ...
   */
  range(start, stop, { extend = false, visibleRange = [0, 1] } = {}) {
    let reversed = false;
...
var CountableTimeInterval = class extends TimeInterval {
  ...
  every(step, options) {
    ...
    if (unsafeStep !== step) {
      import_ag_charts_core24.Logger.warnOnce(`interval step of [${unsafeStep}] rounded to [${step}].`);
    }
    ...
    return new TimeInterval(encode7, decode7, rangeCallback);
  }
};
...
var second = new CountableTimeInterval(encode, decode);
...
var minute = new CountableTimeInterval(encode2, decode2);
...
var hour = new CountableTimeInterval(encode3, decode3);
...
var day = new CountableTimeInterval(encode4, decode4);
...
function weekday(weekStart) {
  ...
  return new CountableTimeInterval(encode7, decode7);
}
...
var month = new CountableTimeInterval(encode5, decode5);
...
function filterVisibleTicks(ticks, reversed, visibleRange) {
  if (visibleRange == null || visibleRange[0] === 0 && visibleRange[1] === 1)
    return ticks;
  const vt0 = (0, import_ag_charts_core25.clamp)(0, Math.floor(visibleRange[0] * ticks.length), ticks.length);
  const vt1 = (0, import_ag_charts_core25.clamp)(0, Math.ceil(visibleRange[1] * ticks.length), ticks.length);
...
var _BandScale = class _BandScale extends AbstractScale {
  ...
  set padding(value) {
    value = (0, import_ag_charts_core26.clamp)(0, value, 1);
  ...
  set paddingInner(value) {
    this.invalid = true;
    this._paddingInner = (0, import_ag_charts_core26.clamp)(0, value, 1);
  }
  get paddingInner() {
    return this._paddingInner;
  }
  set paddingOuter(value) {
    this.invalid = true;
    this._paddingOuter = (0, import_ag_charts_core26.clamp)(0, value, 1);
  }
  get paddingOuter() {
  ...
  refresh() {
    ...
    this.update();
    if (this.invalid) {
      import_ag_charts_core26.Logger.warnOnce("Expected update to not invalidate scale");
    }
  }
  ...
  ordinalRange(i) {
    ...
    return (0, import_ag_charts_core26.clamp)(min, inset + step * i, max);
  }
};
__decorateClass([
  Invalidating
...
function tickStep(start, end, count, minCount = 0, maxCount = Infinity) {
  if (start === end) {
    return (0, import_ag_charts_core27.clamp)(1, minCount, maxCount);
  } else if (count < 1) {
    return NaN;
  }
...
function tickFormat(ticks, format) {
  const options = (0, import_ag_charts_core27.parseNumberFormat)(format ?? ",f");
  ...
  const formatter = (0, import_ag_charts_core27.createNumberFormatter)(options);
...
function range(start, end, step) {
  ...
  const f = 10 ** (0, import_ag_charts_core27.countFractionDigits)(step);
...
function isDenseInterval(count, availableRange) {
  if (count >= availableRange) {
    import_ag_charts_core27.Logger.warnOnce(
...
var _ContinuousScale = class _ContinuousScale extends AbstractScale {
  ...
  convert(value, clamp10 = this.defaultClamp) {
    const { domain } = this;
...
__decorateClass([
  SceneChangeDetection({ convertor: (v) => (0, import_ag_charts_core28.clamp)(0, v, 1) })
...
var HdpiCanvas = class {
  constructor(options) {
    ...
    this.pixelRatio = options.pixelRatio ?? (0, import_ag_charts_core29.getWindow)("devicePixelRatio") ?? 1;
    this.element = canvasElement ?? (0, import_ag_charts_core29.createElement)("canvas");
...
function debugStats(layersManager, debugSplitTimes, ctx, renderCtxStats, extraDebugStats = {}, seriesRect = BBox.zero) {
  ...
  ].filter(import_ag_charts_core30.isString);
...
function prepareSceneNodeHighlight(ctx) {
  const config = (0, import_ag_charts_core30.toArray)((0, import_ag_charts_core30.getWindow)("agChartsSceneDebug"));
  const result = [];
...
function debugSceneNodeHighlight(ctx, debugNodes) {
  ...
  for (const [name, node] of Object.entries(debugNodes)) {
    ...
    if (!bbox) {
      import_ag_charts_core30.Logger.log(`Scene.render() - no bbox for debugged node [${name}].`);
      continue;
    }
    ctx.globalAlpha = 0.8;
    ctx.strokeStyle = "red";
...
var Scene = class {
  ...
  download(fileName, fileFormat) {
    (0, import_ag_charts_core31.downloadUrl)(this.canvas.toDataURL(fileFormat), fileName?.trim() ?? "image");
  }
...
var Arc = class extends Path {
  ...
  get fullPie() {
    return (0, import_ag_charts_core32.isNumberEqual)(normalizeAngle360(this.startAngle), normalizeAngle360(this.endAngle));
  }
  updatePath() {
...
var Line = class extends Shape {
  ...
  toSVG() {
    if (!this.visible)
      return;
    const element = (0, import_ag_charts_core33.createSvgElement)("line");
...
var RadialColumnShape = class extends Path {
  ...
  updateBeveledPath() {
    ...
    const isStackBottom = (0, import_ag_charts_core34.isNumberEqual)(innerRadius, axisInnerRadius);
    ...
    const isEmpty2 = (0, import_ag_charts_core34.isNumberEqual)(innerRadius, outerRadius);
    ...
    if (isEmpty2 && shouldConnectBottomCircle) {
      ...
      if (!(0, import_ag_charts_core34.isNumberEqual)(topIntersectionX, 0)) {
